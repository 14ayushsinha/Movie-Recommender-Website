...
with open(r'C:\Users\Ayush Sinha\Desktop\Movie_Recommender_App\Movie_Recommender_App-master\Data\movie_data.json', 'r+', encoding='utf-8') as f:
    data = json.load(f)
with open(r'C:\Users\Ayush Sinha\Desktop\Movie_Recommender_App\Movie_Recommender_App-master\Data\movie_titles.json', 'r+', encoding='utf-8') as f:
...
st.set_page_config(
    page_title="Movie Recommender Website"

)


def run():
    img1 = Image.open(r'C:\Users\Ayush Sinha\Desktop\Movie_Recommender_App\Movie_Recommender_App-master\Data\poplogo.jpeg')
    img1 = img1.resize((250, 250), )
    st.image(img1, use_column_width=False)
    st.title("Movie Recommender Website")
